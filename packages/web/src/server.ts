import { NotionClient, OpenAIClient } from '@shochan_ai/client';
import { builPrompt, LLMAgentReducer, NotionToolExecutor, taskAgentTools } from '@shochan_ai/core';
import dotenv from 'dotenv';
import app from './app';
import { registerFallbackHandlers } from './middleware/fallback-handlers';
import { type AgentDependencies, createAgentRouter } from './routes/agent';
import { createStreamRouter, type StreamDependencies } from './routes/stream';
