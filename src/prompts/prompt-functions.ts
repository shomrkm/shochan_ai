// src/prompts/prompt-functions.ts
...
2. Determine if they want to create a single task or a larger project
3. Focus on understanding WHAT they want to create before gathering details
4. Don't create anything yet - gather essential information first
...
Remember: Ask ONE focused question at a time to avoid overwhelming the user.
`
};
...
Focus on efficiency: get the essential information quickly, then create!
`
};
